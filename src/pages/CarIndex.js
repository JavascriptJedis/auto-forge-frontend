...
const CarIndex = ({ cars }) => {
  ...
  const handleSearch = (query) => {
    ...
    // Filter cars based on the search query
      ...
      const carDescription = car && car.description ? car.description.toLowerCase() : "";

      return carMake.includes(lowerCaseQuery) || carModel.includes(lowerCaseQuery) || carDescription.includes(lowerCaseQuery);
    });
